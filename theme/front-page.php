...
<main>
  ...
  <!-- タブ切り替え -->
  <div class="tab_switching">
    <div>
      <span class="tab_switching--btn is-active_btn" data-tab="tab1">タブ1</span>
      <span class="tab_switching--btn" data-tab="tab2">タブ2</span>
      <span class="tab_switching--btn" data-tab="tab3">タブ3</span>
      <span class="tab_switching--btn" data-tab="tab4">タブ4</span>
    </div>
    <div class="tab_switching--contents is-active_contents fade-panel" id="tab1">
      <h3>タブ1のコンテンツ</h3>
      <p>これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。これはタブ1の内容です。フェード効果で表示されます。</p>
    </div>
    <div class="tab_switching--contents fade-panel" id="tab2">
      <h3>タブ2のコンテンツ</h3>
      <p>これはタブ2の内容です。フェード効果で表示されます。</p>
    </div>
    <div class="tab_switching--contents fade-panel" id="tab3">
      <h3>タブ3のコンテンツ</h3>
      <p>これはタブ3の内容です。フェード効果で表示されます。</p>
    </div>
    <div class="tab_switching--contents fade-panel" id="tab4">
      <h3>タブ4のコンテンツ</h3>
      <p>これはタブ4の内容です。フェード効果で表示されます。</p>
    </div>
  </div>
  <br>
  <br>
